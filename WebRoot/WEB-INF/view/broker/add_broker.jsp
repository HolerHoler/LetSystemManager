...
<body>
	<article class="page-container"> <s:form namespace="/action"
		action="addBroker" class="form form-horizontal" method="post">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<!-- 				<input type="button" id="addBroker_0" value="增加"
		...
		<s:textfield name="broker.work_address" label="工作地址" /> 	<s:submit value="添加" class="btn btn-primary radius" />--%>
...
<script type="text/javascript">
	/* 	$(document).ready(function() {
	 $("#addBroker_0").click(function() {
	 //	$("#updatedLet").ajaxSubmit();

	 $("#addBroker").ajaxSubmit(function(result) {
